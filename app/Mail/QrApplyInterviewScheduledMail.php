...
class QrApplyInterviewScheduledMail extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: "Mülakatınız Planlandı — {$companyName}",
        );
    }
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'emails.qr-apply-interview-scheduled',
            with: [

...
namespace App\Http\Controllers\Api\OctoAdmin;
...
class CompetencyModelController extends Controller
{
    ...
    /**
     * GET /v1/octopus/admin/competencies
     * Full competency library.
     */
    ...
    /**
     * GET /v1/octopus/admin/companies/{companyId}/competency-models
     */
    public function index(string $companyId): JsonResponse
    {
        $models = CompanyCompetencyModel::withoutGlobalScope(TenantScope::class)
    ...
    /**
     * POST /v1/octopus/admin/companies/{companyId}/competency-models
     */
    ...
    /**
     * PUT /v1/octopus/admin/competency-models/{id}
     */
    public function update(Request $request, string $id): JsonResponse
    {
        $model = CompanyCompetencyModel::withoutGlobalScope(TenantScope::class)->findOrFail($id);
    ...
    /**
     * DELETE /v1/octopus/admin/competency-models/{id}
     */
    ...
    /**
     * POST /v1/octopus/admin/competency-models/{id}/set-default
     */

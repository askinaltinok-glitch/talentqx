...
<div style="max-width: 600px; margin: 0 auto; background: #ffffff;">
    <div style="background: linear-gradient(135deg, #059669 0%, #10b981 100%); padding: 30px 40px; text-align: center;">
        ...
        <h1 style="color: #ffffff; font-size: 22px; margin: 0; font-weight: 600;">Tebrikler!</h1>
    </div>

    <div style="padding: 40px;">
        <h2 style="color: #065f46; font-size: 20px; margin: 0 0 20px;">Merhaba {{ $candidate->first_name ?? 'Aday' }},</h2>

        <div style="background: #f0fdf4; border-left: 4px solid #22c55e; padding: 20px; margin: 24px 0; border-radius: 0 8px 8px 0;">
            <p style="margin: 4px 0; color: #166534; font-size: 15px;"><strong>Başvurunuz {{ $companyName }} tarafından onaylanmıştır!</strong></p>
        </div>

        <p style="color: #4a5568; font-size: 15px; line-height: 1.7; margin: 0 0 16px;">{{ $companyName }} firmasının {{ $positionTitle }} pozisyonu için yaptığınız başvuru değerlendirilmiş ve olumlu sonuçlanmıştır.</p>
        ...
        <div style="background: #f0f7ff; border-left: 4px solid #667eea; padding: 16px 20px; margin: 24px 0; border-radius: 0 8px 8px 0;">
            ...
            <p style="margin: 4px 0; color: #2d3748; font-size: 14px;"><strong style="color: #4c1d95;">Durum:</strong> Onaylandı</p>
        </div>
        ...
        <div style="background: #fefce8; border-left: 4px solid #eab308; padding: 16px 20px; margin: 24px 0; border-radius: 0 8px 8px 0;">
            ...
            <p style="margin: 4px 0; color: #713f12; font-size: 14px;">Firma yetkilileri sizinle doğrudan iletişime geçecek ve işe başlama süreci hakkında detaylı bilgi verecektir. Lütfen telefon ve e-posta bilgilerinizin güncel olduğundan emin olun.</p>
        </div>

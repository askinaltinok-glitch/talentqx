...
<div style="max-width: 600px; margin: 0 auto; background: #ffffff;">
    ...
    <div style="padding: 40px;">
        ...
        <p style="color: #4a5568; font-size: 15px; line-height: 1.7; margin: 0 0 16px;">Bugün bu pozisyon için başvurunuz alınmıştır. Başvurunuzu kaldığınız yerden tamamlamak için aşağıdaki butona tıklayın.</p>

        <div style="background: #fffbeb; border: 2px solid #f59e0b; border-radius: 12px; padding: 20px; margin: 24px 0; text-align: center;">
            <p style="font-size: 15px; font-weight: 600; color: #92400e; margin: 0;">Başvurunuz daha önce kaydedilmiştir</p>
            <p style="font-size: 13px; color: #78716c; margin: 8px 0 0;">Aynı pozisyona gün içinde tekrar başvuru yapılamaz</p>
        </div>

        <div style="text-align: center;">
            <a href="{{ $interviewUrl }}" style="display: inline-block; background: #667eea; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-size: 16px; font-weight: 600; margin: 24px 0;">Başvurumu Tamamla</a>
        </div>
